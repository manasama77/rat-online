...
<section class="content">
	...
	<?php
	if($arr->row()->status_rat == 0 || $this->session->userdata(UNQ.'flag_ketua_sidang') == 'ya' || $this->session->userdata(UNQ.'id_jabatan') == '0'){
		?>
		<div class="row">
					...
					<div class="box-body">
						...
						<form action="<?=site_url('admin/rat/store_polling');?>" method="post">
							<div class="form-group">
								...
								<select class="form-control select2" id="id_anggota" name="id_anggota" data-placeholder="Pilih Ketua Sidang" required>
									<option value=""></option>
									<?php
									if($arr_anggota->num_rows() > 0){
										foreach ($arr_anggota->result() as $keya) {
											/* JIKA RULESNYA ANGGOTA TIDAK BISA VOTE DIRI SENDIRI GUNAKAN INI
			...
			<div class="col-md-5 col-sm-12 col-xs-12">
				...
				<div class="box box-success">
					<div class="box-header">
						<h3 class="box-title">
							Quick Count - Vote Ketua Sidang<br>
							<small>
								Periode RAT: 
	...
	<?php
	if($arr->row()->status_rat == 1 || $this->session->userdata(UNQ.'flag_ketua_sidang') == 'ya' || $this->session->userdata(UNQ.'id_jabatan') == '0'){
		?>
		<div class="row">
